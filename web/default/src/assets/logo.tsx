...
// 该 Logo 只输出固定 SVG 内容，不接受外部样式与属性（保留参数类型以兼容调用方）。
export function Logo(_props: SVGProps<SVGSVGElement>) {
  return (
    <svg
