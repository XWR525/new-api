...
export function processChartData(
  ...
  const makeTooltipDimensionUpdateContent = (options?: {
    ...
    return (array: TooltipLineItem[]) => {
      // Hide series with zero consumption at the hovered time point
      ...
      tooltip: {
        ...
        dimension: {
          ...
          updateContent: (
            ...
            // Hide series with zero calls at the hovered time point
      ...
      tooltip: {
        ...
        dimension: {
          ...
          updateContent: (
            ...
            // Hide users with zero consumption at the hovered time point
            array = array.filter((item) => (Number(item.value) || 0) !== 0)
            array.sort(
              (a, b) => (Number(b.value) || 0) - (Number(a.value) || 0)
            )
