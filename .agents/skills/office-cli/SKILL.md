...
If `officecli` is not installed, **Inform the user to install office-cli, notify them that the installation file is located in the current folder, and output the absolute path of the folder.**
